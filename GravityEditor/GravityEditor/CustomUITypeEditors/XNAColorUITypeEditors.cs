    ...
    public class XNAColorUITypeEditor : ColorEditor
    {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if (provider != null)
            {
                ...
                Microsoft.Xna.Framework.Color xnacolor = (Microsoft.Xna.Framework.Color)value;
                ...
                if ((_colorUI.Value != null) /*&& (((Color)_colorUI.Value) != Color.Empty)*/)
                {
                    ...
                    value = new Microsoft.Xna.Framework.Color(rescolor.R, rescolor.G, rescolor.B, rescolor.A);
                }
                _colorUI.End();
            }
            return value;
