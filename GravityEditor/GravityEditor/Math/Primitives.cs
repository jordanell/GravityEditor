...
namespace GravityEditor
{
    class Primitives
    {
        ...
        public Primitives()
        {
            pixel = new Texture2D(GravityEditor.Instance.GraphicsDevice, 1, 1);
            pixel.SetData(new[] { Color.White });
            circle = CreateCircleTexture(GravityEditor.Instance.GraphicsDevice, circleTextureRadius, 0, 1, 1, Color.White, Color.White);
        }
